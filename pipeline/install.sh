...
SERVICE_FILES=("inside-coder.service" "inside-reviewer.service" "inside-tester.service")
...
show_status() {
    ...
    info "Просмотр логов: journalctl -u inside-coder -f"
    info "Остановить всё: systemctl stop inside-coder inside-reviewer inside-tester"
    echo ""
